// Iconos SVG reutilizables para toda la app
// Cada icono es un path SVG inline — sin dependencias externas
...
function svgWrapper(children: React.ReactNode, { size = 20, className = '', color }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconDecrypt(props: IconProps) {
  return svgWrapper(
    <>
      <rect x="3" y="11" width="18" height="11" rx="2" ry="2" />
      <path d="M7 11V7a5 5 0 0 1 9.9-1" />
